<template>
    ...
    >
        <template #paginatorstart>
            <span>
                Zonas {{ pagination.from }} a {{ pagination.to }} de
                {{ pagination.total }}
            </span>
        </template>
        ...
        <template #header>
            ...
            >
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span
                        class="px-3 py-1 text-white rounded-full text-sm"
            ...
            <template #body="slotProps">
                <div class="flex gap-2">
                    <Button
                        ...
                        tooltip="Editar"
                        @click="
                            console.log('Editando:', slotProps.data);
                            $emit('open-edit', slotProps.data);
                        "
                    />
                    <Button
                        icon="pi pi-trash"
